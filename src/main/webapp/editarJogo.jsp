        ...
        <form action="editar_jogo" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="novoPlataforma" class="form-control mb-2" placeholder="Plataforma" value="${jogo.getPlataforma()}">
                    ...
                    <button type="submit" class="btn btn-dark mt-2">Atualizar jogo</button>
                </div>
